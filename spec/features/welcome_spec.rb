...
describe "The quizzes page" do
  ...
  describe "clicking the button with JavaScript enabled", :js => true do
    ...
    it "changes the body's background to green if input is ascending", :js => true do
      expect(page).to have_css('body.green')
    end

    it "changes the body's background to red if input is not ascending", :js => true do
